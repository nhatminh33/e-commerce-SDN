                    ...
                    <div className='flex justify-start flex-col gap-6'>
                        ...
                        <ul className='flex flex-col justify-start items-start text-sm font-medium uppercase'>
                            ...
                            <li>
                                <Link 
                                    to='/about'
                                    className={`py-2 block ${pathname === '/about' ? 'text-pink-500' : 'text-gray-600 hover:text-pink-500 transition-all'}`}
                                >
                                    About Us
                                </Link>
                            </li>
                            <li>
                                <Link 
                                    to='/contact'
                                    className={`py-2 block ${pathname === '/contact' ? 'text-pink-500' : 'text-gray-600 hover:text-pink-500 transition-all'}`}
                                >
                                    Contact Us
                                </Link>
                            </li>
                            ...
                            <div className='bg-white relative rounded-md shadow-sm'>
                                ...
                                >
                                    <ul className='py-2 text-gray-600'>
                                        {categorys.map((c, i) => (
                                            <li key={i} className='flex justify-start items-center gap-2 px-[24px] py-[6px] hover:bg-pink-50 transition-all'>
                                                <img src={c.image} className='w-[30px] h-[30px] rounded-full border border-pink-100 object-cover' alt={c.name} />
                                                <Link to={`/products?category=${c.name}`} className='text-sm block hover:text-pink-500 transition-all'>{c.name}</Link>
                                            </li>
                                        ))}
                                    </ul>
                                </div>
